...
const Signup = () => {
  ...
  return (
    <div className="font-sans min-h-screen bg-gradient-to-br from-primary/5 via-neutral-white to-primary/10 pt-16 pb-4 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative flex items-center justify-center min-h-[calc(100vh-4rem)] py-2 z-10">
        {/* Main Card with Glass Morphism */}
        <div className="w-full max-w-sm sm:max-w-md lg:max-w-lg mx-auto pt-10">
          <div className="bg-neutral-white/10 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-2xl p-4 sm:p-6 lg:p-8 border border-primary/20 relative overflow-hidden">
            
            {/* Header Section */}
            <div className="text-center mb-4 sm:mb-6">
              
              {/* Title */}
              <h1 className="text-xl sm:text-2xl md:text-3xl font-bold font-header text-neutral-dark mb-1 sm:mb-2 leading-tight">
                Create Your <span className="text-primary font-header">Account</span>
              </h1>
              
              {/* Subtitle */}
              <p className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4">
                Start your 14-day free trial and transform your HR operations
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="input-field h-10 sm:h-11 text-sm sm:text-base bg-neutral-white/80 backdrop-blur-sm border-neutral-medium/30 focus:border-primary/50 focus:bg-neutral-white transition-all duration-300"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="input-field h-10 sm:h-11 text-sm sm:text-base bg-neutral-white/80 backdrop-blur-sm border-neutral-medium/30 focus:border-primary/50 focus:bg-neutral-white transition-all duration-300"
                >
                  <option value="basic">Basic Plan - Free Trial</option>
                  <option value="premium">Professional Plan - Free Trial</option>
                </select>
              </div>
              ...
              <button
                type="submit"
                className="group w-full bg-gradient-to-r from-primary to-purple-800 text-white h-10 sm:h-11 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 font-semibold text-sm sm:text-base transform hover:scale-[1.02] hover:-translate-y-0.5 mt-4"
              >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 sm:gap-3 bg-neutral-white/70 backdrop-blur-sm text-neutral-dark border border-neutral-medium/30 h-10 sm:h-11 rounded-xl shadow-sm hover:shadow-md hover:bg-neutral-white/90 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all duration-300 font-medium text-sm sm:text-base"
            >
              <img
            ...
            <div className="text-center mt-4 sm:mt-5 space-y-2">
              ...
              {/* Feature List */}
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-xs text-gray-500 justify-center mt-2 sm:mt-3">
                <div className="flex items-center">
                  <svg className="w-3 h-3 text-primary mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-center">
                  ...
                  <span className="hidden sm:inline">Setup in 5 minutes</span>
